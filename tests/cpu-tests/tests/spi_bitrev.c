...
volatile spi_divider_t *spi_divider = (volatile spi_divider_t *)SPI_DIVIDER;
...
uint32_t bitrev(uint32_t data)
{
    ...
    */
    ...
    spi_ss->ss = 0; // bitrev slave: 7, flash slave: 0
